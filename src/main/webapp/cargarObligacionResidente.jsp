...
<form action="CargarObligacionResidente" method="post" class="w-50 mx-auto">
    <label class="mb-4">Documento del residente</label>
    ...
    <button type="submit" class="cursor-pointer mb-4 btn mx-auto bg-dark text-white">Cargar Obligacion</button>
