...
<form action="GoHome" method="post" class="w-50 mx-auto">
    <h2>Paz y Salvo</h2>
    <p>El propietario: <%out.print(name);%> se encuentra en paz y salvo con sus pagos</p>
    <p>Direccion propiedad: <%out.print(address);%></p>
    <p>Fecha de paz y salvo <%out.print(date);%></p>
