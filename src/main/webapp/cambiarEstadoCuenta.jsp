...
<form action="CambiarEstadoCuenta" method="post" class="w-50 mx-auto">

    <label>Documento de propietario</label>
    <input required type="number" class="form-control mb-4" name="document" placeholder="Documento">

    <label>Seleccione estado</label>
    <select name="state" class="w-100 browser-default custom-select">
        <option value="Al dia">Al dia</option>
        <option value="Con deuda">Con deuda</option>
        <option value="Moroso">Moroso</option>
        <option value="En acuerdo de pago">En acuerdo de pago</option>
        <option value="Cobro coactivo">Cobro coactivo</option>
        <option value="En proceso de embargo">En proceso de embargo</option>
    </select>

    <button type="submit" class="my-4 cursor-pointer btn mx-auto bg-dark text-white">Cambiar estado de cuenta</button>
