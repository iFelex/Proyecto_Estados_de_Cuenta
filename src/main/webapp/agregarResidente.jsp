...
<form action="AgregarResidente" method="post" class="w-50 mx-auto">
    <input required type="number" class="form-control mb-4" name="document" placeholder="Documento">
    <input required type="text" class="form-control mb-4" name="name" placeholder="Nombre">
    <input required type="number" class="form-control mb-4" name="tel" placeholder="Telefono">
    <input required type="text" class="form-control mb-4" name="address" placeholder="Direccion">
    <button type="submit" class="cursor-pointer mb-4 btn mx-auto bg-dark text-white">Agregar Residente</button>
    ...
    <%
        ...
        if (error == -1){out.print("<div class=\"alert alert-danger\" role=\"alert\">No se pudo agregar residente</div>\n");}
    %>
</form>
