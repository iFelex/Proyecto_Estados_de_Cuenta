...
<form action="GenerarPaz_y_Salvo" method="post" class="w-50 mx-auto">
    <label class="mb-4">Ingrese documento</label>
    <input required type="number" class="form-control mb-4" name="document" placeholder="Documento">
    <button type="submit" class="cursor-pointer mb-4 btn mx-auto bg-dark text-white">Generar Paz y Salvo</button>
    ...
    <%
        ...
        if (error == -2){out.print("<div class=\"alert alert-danger\" role=\"alert\">El propietario no esta a paz y salvo con pagos</div>\n");}
    %>
</form>
